...
var _default = {
  controlPanelSections: [_NVD3Controls.timeSeriesSection[0], {
    ...
    expanded: true,
    controlSetRows: [['color_scheme', 'label_colors'], [_NVD3Controls.showBrush, {
      name: 'send_time_range',
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Propagate'),
        renderTrigger: true,
        default: false,
        description: (0, _core.t)('Send range filter events to other charts')
      }
    }, _NVD3Controls.showLegend], [_NVD3Controls.richTooltip, _NVD3Controls.showMarkers], [_NVD3Controls.lineInterpolation]]
  }, {
