...
const metadata = new _core.ChartMetadata({
  ...
  description: '',
  name: (0, _core.t)('Multiple Line Charts'),
  thumbnail: _thumbnail.default,
  useLegacyApi: true
});

class LineChartPlugin extends _core.ChartPlugin {
  constructor() {
    super({
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('./LineMulti'))),
      metadata,
