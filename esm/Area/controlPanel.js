...
export default {
  controlPanelSections: [timeSeriesSection[0], {
    ...
    expanded: true,
    controlSetRows: [[showBrush, showLegend], [lineInterpolation, {
      name: 'stacked_style',
      config: {
        type: 'SelectControl',
    ...
    }], ['color_scheme', 'label_colors'], [richTooltip, showControls]]
  }, {
    label: t('X Axis'),
    ...
    tabOverride: 'customize',
    expanded: true,
    controlSetRows: [['y_axis_format', yAxisBounds], [yLogScale, null]]
