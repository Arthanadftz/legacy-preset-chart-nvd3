...
export default {
  ...
  controlPanelSections: [{
    ...
    controlSetRows: [['color_scheme', 'label_colors'], [showLegend, null]]
  }, {
    label: t('X Axis'),
    expanded: true,
    tabOverride: 'customize',
    controlSetRows: [[xAxisLabel, leftMargin], [{
    ...
    expanded: true,
    tabOverride: 'customize',
    controlSetRows: [[yAxisLabel, bottomMargin], ['y_axis_format', null], [yLogScale, yAxisShowMinmax]]
  }],
  controlOverrides: {
    color_scheme: {
      renderTrigger: false
